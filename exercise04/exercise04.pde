...
void draw() {
  ...
  /////////////////// BOBBIES ///////////////////
  //
  // They don't gain energy from colliding with each other but from colliding with griddies

  for (int i = 0; i < bobbies.length; i++) {
    
    // Checks if bobbies and griddies are colliding
    bobbies[i].collide(griddies[i]);
